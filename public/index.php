<?php
// public/index.php - copia aquí todo el contenido de tu index.html
?>
...
<body>
    ...
    <div class="full-height">
        ...
        <table border="0">
            <tr>
                <td width="80%">
                    <font class="edoc-logo">Admin Medical </font>
        ...
        <p class="sub-text2 footer-hashen">A Web Solution by love.</p>
    </center>
